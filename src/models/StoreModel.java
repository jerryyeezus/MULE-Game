...
public class StoreModel implements Serializable {
		...
		/**
		 * Method that reduces the food items from the Store based on the integer parameter.
		 * 
		 * @param value
		 */
		...
		/**
		 * Method that increases the food items from the Store based on the integer parameter.
		 * 
		 * @param value
		 */
		...
		/**
		 * Method that increases the drink items from the Store based on the integer parameter.
		 * 
		 * @param value
		 */
		...
		/**
		 * Method that reduces the drink items from the Store based on the integer parameter.
		 * 
		 * @param value
		 */
		...
		/**
		 * Method that increases the Nicolas Cage from the Store based on the integer parameter.
		 * 
		 * @param value
		 */
		...
		/**
		 * Method that reduces the Nicolas Cage from the Store based on the integer parameter.
		 * 
		 * @param value
		 */
